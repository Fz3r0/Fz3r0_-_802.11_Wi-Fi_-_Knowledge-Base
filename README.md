...
📡 AP ::  --------->>>  ➡️ BROADCAST 🛸  ||     {[ 💊🛸 Beacon ]}   (optional/passive scanning) 

📡 AP ⬅️  <<<--------   :: STA 🤳🏾        ||     {[ 💊❓ Probe Request ]}   (active scanning)       <<<=== START 🏁

📡 AP ::  --------->>>  ➡️ STA 🤳🏾        ||     {[ 💊❓ Probe Response ]}  

📡 AP ⬅️  <<<--------   :: STA 🤳🏾        ||     {[ 💊🆗 ACK ]} 

📡 AP ⬅️  <<<--------   :: STA 🤳🏾        ||     {[ 💊🚪 Authentication SeqNum=1 (request) ]} 

📡 AP ::  --------->>>  ➡️ STA 🤳🏾        ||     {[ 💊🆗 ACK ]}

📡 AP ::  --------->>>  ➡️ STA 🤳🏾        ||     {[ 💊🚪 Authentication SeqNum=2 (success) ]} 
...
####################################################################################################################
               ...
               📡 AP ⬅️  <<<------------- {[💊🛜 Association Request]}  -------------  :: STA 🤳🏾  <<<=== START 🏁

               📡 AP ::  ------------------------ {[💊🆗 ACK]} ------------------>>>   ➡️ STA 🤳🏾

               📡 AP ::  ---------------- {[💊🛜 Association Response]} ---------->>>  ➡️ STA 🤳🏾
