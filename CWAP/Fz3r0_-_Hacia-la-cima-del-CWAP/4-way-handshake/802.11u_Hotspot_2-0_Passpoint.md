...
El protocolo que utiliza Hotspot 2.0 es obviamente el `IEEE 802.11` (Wi-Fi) donde específicamente contiene diferentes Frames e Elements:

### Passpoint IE: `Beacon Frame`

- `Advertisement Protocol Element`
- `Interworking Field`
- `Vendor Specific: Wi-Fi Alliance – Hotspot 2.0 Indication Field`

### Passpoint IE: `Action Frames`

- Generic Advertisement Service (GAS)
- Access Network Query Protocol (ANQP) :: Wrapped inside the GAS Protocol

### Passpoint IE: `EAP Frames`

Depending on the type of EAP is the type of EAP frame used. Hotspot 2.0 uses: 
