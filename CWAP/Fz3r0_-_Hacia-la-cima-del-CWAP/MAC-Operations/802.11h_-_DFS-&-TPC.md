...
Military RADAR band nomenclature, L, S, C, X, Ku, and K bands originated during World War II as a secret code so scientists and engineers could talk about frequencies without divulging them. 
...
![image](https://github.com/user-attachments/assets/6797d5a6-8509-4045-9224-e062049bbefc)
...
![image](https://github.com/user-attachments/assets/326389c9-b5d8-46e9-90de-786c467bd400)


### DFS & CSA: `Manual CH Config` - `Only CSA` - `From: Non-DFS | To: DFS`

![image](https://github.com/user-attachments/assets/a2887450-d467-40c4-adcb-e1167ee58ac0)
