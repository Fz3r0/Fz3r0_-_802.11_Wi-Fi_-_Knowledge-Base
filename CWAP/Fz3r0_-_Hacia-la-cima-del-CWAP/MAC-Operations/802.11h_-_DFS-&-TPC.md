...
The AP used in this lab is a `Ruckus R550`, the specs are the following: 
...
- The AP automatically selects channels with low interference levels.
...
- The AP will continously performs `In-Service Monitoring (ISM)` to detect active RADAR signals.
