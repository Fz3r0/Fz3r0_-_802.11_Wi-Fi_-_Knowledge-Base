...
1. **802.11k (RRM / assisted roaming / neighbor report) informs clients for roaming decisions whereas 802.11v (WNM) manages roaming of the client STA based on AP determination (AP use information from 802.11k).**
